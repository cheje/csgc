    ...
    return (
        ...
        <div>
            <section>
                ...
                <p>
                    Cap rates can serve as a qualitiative variable in helping to suspect potentially <a href='https://www.forbes.com/sites/forbesbusinesscouncil/2021/04/05/the-dos-and-donts-of-investing-in-distressed-properties/?sh=4d9708f6628f' target='_blank'>distressed housing, which means</a> that the property is on the verge of foreclosure or in the hands of a bank or lender. These buildings attract investors because of their lower market rates. Other indicators of distress include lawsuits, code violations, tenant complaints and deferred or disruptive maintenance, the end goal being tenant turnover. The NYC Department of Housing Preservation and Development analyzes cap rates when populating its <a href='https://data.cityofnewyork.us/Housing-Development/Speculation-Watch-List/adax-9mit' target='_blank'>Speculation Watch List</a>, of mostly rent-regulated multiple dweeling units. HPD compares a property's cap rate, which it <a href='https://www1.nyc.gov/site/hpd/about/speculation-watch-list.page' target='_blank'>describes</a> as the building's "net operating income divided by its sales price" to the median cap rate of similar properties purchased in the same borough. Those with cap rates below the median value of the borough make the list. In their "<a href='https://www1.nyc.gov/assets/hpd/downloads/pdfs/services//speculation-watch-list-adopted-rules.pdf' target='_blank'>Statement of Basis and Purpose</a>" for the speculation watch list, HPD states: <br /><br />
