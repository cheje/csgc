  ...
  chapters: [
    {
      ...
      description:
        'Scroll through to see residential buildings that have been covered by local news outlets for reasons that might suggest speculation on the part of the owner.',
      location: {
    ...
    },
    {
      ...
      //image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/ea/2015-06-19_Glacier_National_Park_%28U.S.%29_8633.jpg/800px-2015-06-19_Glacier_National_Park_%28U.S.%29_8633.jpg',
      description:
        'Two Bridges highrises planned for the Lower East Side waterfront',
    ...
    },
    {
      ...
      headline:
        'Locals blast proposed Crown Heights development at City Planning Hearing',
      location: {
    ...
    },
    {
      ...
      headline:
        'Hunters Point New survey shows Hunters Point is third most apartment-crazed neighborhood in U.S.',
      location: {
    ...
    },
    {
      ...
      headline:
        'Corona Planned 25-story luxury development in Corona slated for completion in 2024',
      location: {
