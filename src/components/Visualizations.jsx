  ...
  return (
    <div>
      <section>
        ...
        <p>
          I am approaching the project from the angle of 'visualizing for analysis,' as{' '}
          <a href='https://flowingdata.com/2021/10/21/process-162-aspects/' target='_blank' rel='noopener noreferrer'>
            Nathan Yau describes in Flowing Data
          </a>
          . As opposed to 'visualizing for communication' with a target audience in mind, in the case of visualizing for
          yourself:
        </p>
        <p>
          <blockquote>
        ...
        <p>
          ...
          look for stories of tenants, whether that be a journalist, an analyst, or an advocate – anyone intent on
          avoiding generalizations or erasing the nuances and disparities of the people and families that can easily get
          overlooked in aggregated data. Perhaps these visualizations can evoke 'question framing,' the term used by{' '}
        ...
        <p>
          ...
          intent of finding individual stories, we can try to go a bit deeper.
        </p>
        <h5 className='subsubhead'>Portfolios</h5>
        <p>The proceeding visualizations will touch on real estate speculation.</p>
        <p>
        ...
        <p>
          In the cases of 'declining investment' in a building, landlords, investors, lenders might consider this an
          ...
          financial distress and risk being foreclosed (Hornbach et al. 2020, 5). Indicators of distress include
          lawsuits, code violations, tenant complaints and deferred or disruptive maintenance.{' '}
          <a
          ...
          estate market and consequently the belief that property values undulate and will go up again at some point
          (Hornbach et al. 2020, 5).
        </p>
        ...
        <br />
        <p>
          That being said, another indicator of speculation is a property owner amassing a considerable number of
          properties in one's portfolio. I proceeded with a bubble chart of landlords with at least 10 properties found
          in the original TCIE data. Buildings have changed hands over the past nearly two decades but at least from
          this collection of more than 25,000 properties, the visualization, color-coded by the borough(s) in which the
          landlord's buildings are found, gives an idea of the comparatively larger portfolios present in this sample of
          buildings. While this is also a chart of aggregated data, in this case, it can lead one in the direction of,
          say, individual landlords for further analysis. Note that with building owner efforts to obscure their
          identities and inputted names spelled or formatted differently, the numbers in the chart from being fully
          precise.
        </p>
        <Bubbles />
        <br />
        <p>
          For some broader context, in '
          <a
          ...
          ,' Sam Rabiyah, the data lead and engineer at{' '}
          <a href='https://www.justfix.nyc/' target='_blank'>
            JustFix.nyc
          </a>
          , details findings of the group's analysis of city landlords who owned rent-regulated housing properties; they
          used the Who Owns What database. 'Larger landlords,' or those with a sizable portfolio of more than 20
          buildings, own about half of the city's rent-regulated properties. Also of note, larger landlords conducted
          'more than half of all executed evictions in 2018.'
        </p>
        <FilteringData />
      </section>
      <Scrollytelling />
